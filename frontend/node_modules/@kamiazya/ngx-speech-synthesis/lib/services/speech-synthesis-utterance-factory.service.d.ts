import { SpeechSynthesisUtteranceEventHandler, SpeechSynthesisUtteranceConfig, SpeechSynthesisUtteranceErrorEventHandler } from '../configs';
/** @dynamic */
export declare class SpeechSynthesisUtteranceFactoryService {
    private _config?;
    private _lang?;
    private _voice?;
    private _volume?;
     ...
     */
    private internal;
    constructor(config?: SpeechSynthesisUtteranceConfig, 
    /**
