declare type VoicesChangedEventHandler = ((this: SpeechSynthesis, ev: Event) => any) | null;
export declare class SpeechSynthesisService {
    /**
     ...
     */
    onvoiceschanged: VoicesChangedEventHandler;
    /**
